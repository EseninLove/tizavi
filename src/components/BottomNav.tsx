          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {badge > 0 && (
                  <span className="absolute -top-2 -right-2.5 min-w-[18px] h-[18px] px-1 flex items-center justify-center text-[10px] font-bold rounded-full bg-tg-button text-tg-button-text">
                    {badge > 99 ? '99+' : badge}
                  </span>
                )}
              </div>
